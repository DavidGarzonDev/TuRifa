...
import { FaTicketAlt, FaCoins, FaTrophy, FaGift, FaDollarSign } from "react-icons/fa";
import CardRifa from "../ui/CardRifa";

const RifasSection = ({ rifas, loading, error, icons }) => {
  return (
